...
namespace QuanLib.DataAnnotations
{
    ...
    public class NewAllowedValuesAttribute : ValidationAttribute
    {
        public NewAllowedValuesAttribute(params object?[] values) : base(ErrorMessageHelper.NewAllowedValuesAttribute)
        {
